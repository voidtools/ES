...
// the width column is find as there is nothing before the word width.
...
PROPERTY_NAME_TO_ID_MACRO("file-list-filename",EVERYTHING3_PROPERTY_ID_FILE_LIST_FILENAME)

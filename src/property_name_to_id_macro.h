...
PROPERTY_NAME_TO_ID_MACRO("file-list-file-name",EVERYTHING3_PROPERTY_ID_FILE_LIST_FILENAME)
...
PROPERTY_NAME_TO_ID_MACRO("flfn",EVERYTHING3_PROPERTY_ID_FILE_LIST_FILENAME)
...
PROPERTY_NAME_TO_ID_MACRO("len",EVERYTHING3_PROPERTY_ID_FILE_NAME_LENGTH)
...
PROPERTY_NAME_TO_ID_MACRO("name-len",EVERYTHING3_PROPERTY_ID_FILE_NAME_LENGTH)
PROPERTY_NAME_TO_ID_MACRO("name-length",EVERYTHING3_PROPERTY_ID_FILE_NAME_LENGTH)
PROPERTY_NAME_TO_ID_MACRO("name-utf-8-byte-length",EVERYTHING3_PROPERTY_ID_FILE_NAME_LENGTH_IN_UTF8_BYTES)
